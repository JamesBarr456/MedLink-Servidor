...
class PatientMedicationsController {
    static add(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { user } = res.locals;
                const Fields = __rest(req.body, []);
                const patientUpdated = yield service_1.default.createOrUpdatePatientMedications(user, Fields);
...
exports.default = PatientMedicationsController;
