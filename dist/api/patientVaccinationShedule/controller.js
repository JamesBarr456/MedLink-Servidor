...
class PatientVaccinationSheduleController {
    static add(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { user } = res.locals;
                const Fields = __rest(req.body, []);
                const patientUpdated = yield services_1.default.createOrUpdatePatientVaccinationShedule(user, Fields);
...
exports.default = PatientVaccinationSheduleController;
