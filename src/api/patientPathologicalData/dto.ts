...
export default class PatientPathologicalDataDto {
    static patientPathologicalDataDTO(
        data: IPatientPathologicalData
    ): Partial<IPatientPathologicalData> {
        return {
            ...
            ...(data.gastrointestinalDiseasesDetails
                ? {
            ...
            ...(data.sexuallyTransmittedDiseasesDetails
                ? {
